...
export const validation = Yup.object().shape({
    ...
    workingWithDisablilties: Yup.string().required("Required"),
    position: Yup.string().required("Required"),
    challanging: Yup.string().required("Required"),
...
howLongAtAddress: Yup.string().required("Required"),
capability: Yup.string().required("Required"),
convicted: Yup.string().required("Required"),
upload: Yup.mixed()
                            ...
                            <div className="p-grid">
                                ...
                                <div className="p-col-12 p-lg-6 p-md-6 p-sm-6">
                                    <Dropdown
                                        ...
                                        optionLabel="name"
                                        placeholder="Do you have any Physical and/mental capabilty to perfom
                                        the essential functions of this job*"></Dropdown>
                            ...
                            <div className="p-grid">
                                <div className="p-col-12 p-lg-6 p-md-6 p-sm-6">
                                    ...
                                    <Dropdown
                                        ...
                                        optionLabel="name"
                                        placeholder="Have you been convicted of any crime*"></Dropdown>
